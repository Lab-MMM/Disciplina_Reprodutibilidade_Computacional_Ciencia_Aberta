...
# Configuração do Git e integração com RStudio {#sec-inicializando}
...
<!-- Existem outras formas de iniciar um repositório que será versionado e conectado -->
<!--     com o GitHub (ou outro serviço de repositório remoto), nessa seção irei  -->
<!--     explorar mais uma forma que esse repositório pode ser iniciado. A execução -->
<!--     desta alternativa assume que você já tenha o Git instalado no seu computador,  -->
<!--     bem como uma conta no GitHub. -->

<!-- ::: {.callout-tip} -->
<!-- ## Dica 💡 -->

<!-- Se você é iniciante, minha recomendação é que utilize a forma de inicialização -->
<!--     demonstrada nas seções anteriores @sec-inicializando -->
<!-- ::: -->

<!-- ## Usando a chave SSH -->

<!-- Ao comunicarmos com o Github estamos, basicamente, interagindo com um servidor  -->
<!--     remoto, que nada mais é que uma máquina abrigada em algum local em um  -->
<!--     centro de processamento de dados que você pode acessar através da internet. -->
<!--     No nosso caso, iremos utilizar o servidor do Github para armazenar remotamente -->
<!--     nosso trabalho versionado. -->

<!-- ```{r echo=FALSE,eval=TRUE,fig.cap="Ilustração da comunicação entre um servidor remoto e sua máquina, imagem retirado do curso [Collaborative coding with GitHub and RStudio](https://lmu-osc.github.io/Collaborative-RStudio-GitHub/)"} -->
<!-- knitr::include_graphics("figuras/github-remote.png") -->
<!-- ``` -->
<!-- Existem diferentes protocolos para realizar essa comunicação, um deles é através -->
<!--     do protocolo https, que foi mostrado na seção anterior. Nessa veremos uma -->
<!--     alternativa utilizando o protocolo SSH, que é considerado mais seguro, porém -->
<!--     pode ser um pouco mais desafiador para quem está iniciando. -->

<!-- Esse protocolo inclui duas partes básicas: -->

<!-- 1. Criando uma chave SSH para o seu computador -->
<!-- 2. Pareando essa chave única com o serviço que quer se comunicar, no nosso caso -->
<!--     o GitHub -->

<!-- ### Criando a chave SSH no seu computador  -->

<!-- Primeiro vamos criar a chave SSH no nosso computador, para isso vamos usar o  -->
<!--     terminal do nosso computador -->

<!-- Primeiro, vamos verificar se já existe uma chave cadastrada -->
...
<!-- Procure se aparecem arquivos como: -->
...
<!-- Se aparecer quer dizer que você já apresenta uma chave pública, caso contrário -->
<!--     vamos criar uma, que pode ser feito da seguinte maneira -->
...
<!-- Substitua com o seu email que está associado a sua conta do GitHub -->

<!-- O seu terminal irá perguntar se você deseja entrar uma passphrase. Você pode  -->
<!--     inserir para aumentar a segurança ou apenas apertar enter. -->

<!-- O próximo passo é adicionar essa chave ao ssh-agent do seu computador. O ssh -->
<!--     agent é um programa de fundo que irá guardar as chaves SSH privadas de maneira -->
<!--     encriptada na memória do seu computador. Os passos para fazer isso irão -->
<!--     variar de acordo com o sistema operacional que você possui. -->

<!-- Se você possuí um Mac OS. Primeiro verifique se o ssh-agent está disponível -->
